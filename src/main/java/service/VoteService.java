    ...
    public String getExampleFileName(String meetingType, int fileType) {
        ...
        switch (meetingType){
            case "Rank":
                ...
                break;
            case "Assessment":
                fileName = new String[]{"升等評分_教授_投票檔.xlsx", "升等評分_教授_結果檔.xlsx", "升等評分_副教授_投票檔.xlsx", "升等評分_副教授_結果檔.xlsx",
                        "升等評分_兼任教授_投票檔.xlsx", "升等評分_兼任教授_結果檔.xlsx", "升等評分_兼任副教授_投票檔.xlsx", "升等評分_兼任副教授_結果檔.xlsx"};
                break;
            case "Agreement":
